...
/**
 * FORK 6 — a chain with no shops is a malformed chain, not a customer outcome, so asking is an error.
 *
...
fun bestOffer(duck: Duck, franchise: Franchise): Offer? {
    require(franchise.shops.isNotEmpty()) { "a chain with no shops cannot be asked for an offer" }
