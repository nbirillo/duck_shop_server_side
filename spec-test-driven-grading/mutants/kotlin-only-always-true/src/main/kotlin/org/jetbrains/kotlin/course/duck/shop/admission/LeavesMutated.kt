...
//
// Mutant kotlin-only-always-true (must-kill)
//   Leaves.kt:  override fun admits(duck: Duck): Boolean = duck.hasKotlinAttribute  ->  override fun admits(duck: Duck): Boolean = true
//
// KotlinOnly ignores the attribute and admits every duck.
// A suite that kills this mutant: a negative-direction test — a duck WITHOUT the Kotlin attribute is rejected
...
class KotlinOnly : AdmissionPolicy {
    override fun admits(duck: Duck): Boolean = true
}
