...
//
// Mutant no-floor (must-kill)
//   Pricing.kt:  private fun reduce(price: Int, discount: Int): Int = (price - discount).coerceIn(0, price)  ->  private fun reduce(price: Int, discount: Int): Int = price - discount
//
// A discount larger than the price drives it negative.
// A suite that kills this mutant: an amount bigger than the duck's price
...
private fun reduce(price: Int, discount: Int): Int = price - discount
