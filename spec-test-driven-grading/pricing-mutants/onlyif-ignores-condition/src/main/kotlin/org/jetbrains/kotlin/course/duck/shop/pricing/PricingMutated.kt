...
//
// Mutant onlyif-ignores-condition (must-kill)
//   Pricing.kt:  if (rule.condition.admits(duck)) apply(duck, rule.rule, price) else price  ->  apply(duck, rule.rule, price)
//
// OnlyIf applies its rule to every duck.
// A suite that kills this mutant: a duck the condition rejects
