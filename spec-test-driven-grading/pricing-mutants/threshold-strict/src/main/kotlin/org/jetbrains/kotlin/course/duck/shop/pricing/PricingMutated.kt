...
//
// Mutant threshold-strict (must-kill)
//   Pricing.kt:  if (price >= rule.threshold) reduce(price, discount = rule.amount) else price  ->  if (price > rule.threshold) reduce(price, discount = rule.amount) else price
//
// The big-spender threshold becomes exclusive.
// A suite that kills this mutant: a duck priced exactly at the threshold
