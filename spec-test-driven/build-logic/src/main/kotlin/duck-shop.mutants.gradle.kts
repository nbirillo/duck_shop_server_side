...
// come from gradle properties (mutantsCatalog / mutantsCoreSrc / mutantsLearnerTests /
// mutantsAuthoredTests / mutantsOut), so the task code is shared.
...
tasks.register<MutationReportTask>("verifyMutants") {
    ...
    description = "Mutation testing: run a suite against every mutant and report the mutation score. " +
        "Params: [-PmutantTests=learner|authored|<path>] [-PmutantsStrict]."
